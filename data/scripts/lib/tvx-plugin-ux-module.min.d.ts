// Type definitions for TVX Plugin UX v0.0.72 (Module)
...
export const Effects: TVXEffects;
export const AnimationController: TVXAnimationController;
export const ColorTools: TVXColorTools;
export const Transit: TVXTransit;
