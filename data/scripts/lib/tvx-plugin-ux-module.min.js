...
if(a.isFullStr(S)){U+=" "+S}if(a.isFullStr(W)){if(a.isFullStr(V)){return a.strReplace(a.strReplace(o.COMMON.HTML.TEXT_STYLED.replace("{STYLE}","color:"+V),"{CLASS}",U),"{TEXT}",a.htmlTextEscape(W))}else{return a.strReplace(a.strReplace(o.COMMON.HTML.TEXT,"{CLASS}",U),"{TEXT}",a.htmlTextEscape(W))}}return a.strReplace(a.strReplace(o.COMMON.HTML.TEXT,"{CLASS}",U),"{TEXT}",a.htmlTextEscape(o.COMMON.TEXT.DEFAULT))};this.createTextStart=function(U,T,S){var V=T===false?o.COMMON.CSS.CLASS_TEXT:o.COMMON.CSS.CLASS_TEXT_INLINE;if(a.isFullStr(S)){V+=" "+S}if(a.isFullStr(U)){return a.strReplace(o.COMMON.HTML.TEXT_START_STYLED.replace("{STYLE}","color:"+U),"{CLASS}",V)}return a.strReplace(o.COMMON.HTML.TEXT_START,"{CLASS}",V)};this.createTextEnd=function(){return o.COMMON.HTML.TEXT_END}};var p=new function(){var ag=16;var ah=32;var S="tvx:device_id";var U=/^[a-z-]+_[A-Za-z0-9]+_[0-9]+([0-9#])*$/;var ad=new s("Ue!m2K(vI$Ekn@uMgGoHCA9V,%DkT(a*OYhHyLI.s!FCFnr3b34.)cP=r&fi1ftc??wz[N~/45'A&-dsP/YW]-Jj~ed]xpl#DWBZ%_8N705+BJSVT,zlhqv_L[b7U$;EQMt0*+QqmgO9Sw'G=o8;6xpK)RRXZuaij6X1@#y2");
var Y=new s("k%hy.nLI1&4rN[D9YAPVCu(*&5F)'aC$=frs,wocT48qpRpXt[Gx$BQZU@B,9N;oL%j*J~hXbW)-#q#z7+0uMgHm3fEHcdK@iIG!?nP!/Y.3vFb~2eUz(sk-O/W?AtJ_VT_8]=+K;DmS6Q1iSx60]jaevER'l7y5ZlOdM2wg");var aj=new s("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789");var ae=new s(a.strShuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"));var ai=new s("tuNiBAmqXwPd-aUIRFHn2YpVQ9gkD7zWC4jMGycJ8v65SrZ0.hO1eLfKboxEl3sT");var Z=function(an,am){return an!=null&&am>=0&&am<an.length?an.charAt(am):"0"};var ab=function(am){return am.indexOf("-")==0?"0"+am.substr(1):am};var ak=function(an,aq,am){var ao=0;for(var ap=an.length;ap<am;ap++){an+=Z(aq,ao++)}return an};var aa=function(am){return ak(ab(""+a.createHash(am)),ab(""+a.createHash(am,true)),ag)};var al=function(am){return a.isFullStr(am)&&U.test(am)};var ac=function(am){if(a.isFullStr(am)&&am.length<ah){return ak(am+"#",ab(""+a.createHash(am))+ab(""+a.createHash(am,true)),ah)}return am};var X=function(am){return a.isFullStr(am)?a.base64DecodeId(ai.normalizeString(am)):null
};var V=function(am){return a.isFullStr(am)?ai.transformString(a.base64EncodeId(ac(am))):null};var W=function(){H.storage.remove(S)};var T=function(an){var am=H.storage.getFullStr(S,null);if(!al(X(am))){am=null}if(am==null&&an!=null&&an.info!=null&&an.info.platform!=null){am=V(an.info.platform+"_"+a.createKey(16)+"_"+I.getTimestamp());H.storage.set(S,am)}return am};var af=function(am){if(am!=null&&am.info!=null&&am.info.platform!=null&&am.info.system!=null){if(am.info.system.macAddress!=null){return V(am.info.platform+"_"+am.info.system.macAddress)}else{if(am.info.system.deviceId!=null){return V(am.info.platform+"_"+am.info.system.deviceId)}else{if(am.info.id!=null){return V(am.info.platform+"_"+am.info.id)}}}}return T(am)};this.checkOrigin=function(am){if(a.isFullStr(am)){return am=="null"||am=="http://msx.benzac.de"||am=="https://msx.benzac.de"||am=="ms-appx://52357benzac.de.mediastationx"||am=="http://localhost"||am.indexOf("http://localhost:")==0||am.indexOf("file://")==0}return false
};this.transformUrl=function(am){return ad.transformString(am)};this.transformString=function(am){return Y.transformString(am)};this.normalizeString=function(am){return Y.normalizeString(am)};this.createHashKey=function(am,an){if(an=="local"){return ae.transformString(aa(am))}return aj.transformString(aa(am))};this.clearDeviceId=function(){W()};this.getDeviceId=function(am){return af(am)}};var b=new function(){var V=new c();var af=null;var ac=false;var Y=null;var ab=function(ai){if(af!=null){var ag=af;af=null;if(ag.length>0){for(var ah=0;ah<ag.length;ah++){ag[ah](ai)}}}};var U=function(ag){if(af==null){af=[]}af.push(ag)};var Z=function(ah,ag){if(a.isFullStr(ag)){if(a.isFullStr(ah)){return ag==ah}return false}return true};var W=function(ag){return ag!=null&&ag.info!=null&&ag.info.framework!=null?a.strFullCheck(ag.info.framework.name,null):null};var X=function(ag){return ag!=null&&ag.info!=null&&ag.info.framework!=null?a.strFullCheck(ag.info.framework.version,null):null};var T=function(ag){return ag!=null&&ag.info!=null&&ag.info.application!=null?a.strFullCheck(ag.info.application.name,null):null
};var aa=function(ag){return ag!=null&&ag.info!=null&&ag.info.application!=null?a.strFullCheck(ag.info.application.version,null):null};var S=function(ag){return ag!=null&&ag.info!=null&&ag.info.content!=null?a.strFullCheck(ag.info.content.name,null):null};var ae=function(ag){return ag!=null&&ag.info!=null&&ag.info.content!=null?a.strFullCheck(ag.info.content.version,null):null};var ad=function(){V.start();V.start();window.addEventListener("load",function(){V.stop()});H.storage.onReady(function(){V.stop()})};this.createCanvas=function(ai,ah,ag){return a.strReplace(o.COMMON.HTML.CANVAS.replace("{WIDTH}",a.strToNum(ah,n.SCREEN_WIDTH)).replace("{HEIGHT}",a.strToNum(ag,n.SCREEN_HEIGHT)),"{CLASS}",a.htmlAttrEscape(ai))};this.createIFrame=function(ag,ah){return a.strReplace(a.strReplace(o.COMMON.HTML.IFRAME,"{CLASS}",a.htmlAttrEscape(ag)),"{SRC}",a.htmlAttrEscape(a.strFullCheck(ah,"about:blank")))};this.isReady=function(){return !V.isBusy()};this.onReady=function(ag){V.onReady(ag)};this.startInitService=function(){V.start()
};this.stopInitService=function(){V.stop()};this.areSettingsValidated=function(){return ac};this.invalidateSettings=function(){ac=false;Y=null};this.validateSettings=function(ao){ac=true;Y=ao;var ax=null;var aj=null;var aA=null;var aB=null;var aq=null;var aI=null;var aH=null;var ay=null;var aD=null;var ak=null;var ag=null;var am=null;var aE=null;var ar=null;var ap=null;var au=null;var aC=null;var aF=null;var ai=null;var az=null;var ah=null;var av=null;var at=null;var aw=null;var an=null;var al=null;var aG=null;if(ao!=null&&ao.info!=null){aH=ao.info.platform;ay=ao.info.id;if(ao.info.time!=null){ax=ao.info.time.offset;aj=ao.info.time.zoneOffset}if(ao.info.screen!=null){aA=ao.info.screen.width;aB=ao.info.screen.height;aq=ao.info.screen.factor;aI=ao.info.screen.zoomFactor}if(ao.info.framework!=null&&ao.info.framework.settings!=null){aD=ao.info.framework.settings.animate;ak=ao.info.framework.settings.transform;ag=ao.info.framework.settings.input;am=ao.info.framework.settings.remote;aE=ao.info.framework.settings.layout;
ar=ao.info.framework.settings.scale;ap=ao.info.framework.settings.zoom;au=ao.info.framework.settings.center;aC=ao.info.framework.settings.background;aF=ao.info.framework.settings.leave;ai=ao.info.framework.settings.exit;az=ao.info.framework.settings.back;ah=ao.info.framework.settings.volume;av=ao.info.framework.settings.busy;at=ao.info.framework.settings.speed;aw=ao.info.framework.settings.playback;an=ao.info.framework.settings.fullscreen;al=ao.info.framework.settings.suspend;aG=ao.info.framework.settings.secure}}n.TIME_OFFSET=a.strToNum(ax,n.TIME_OFFSET);n.TIME_ZONE_OFFSET=a.strToNum(aj,n.TIME_ZONE_OFFSET);n.SCREEN_WIDTH=a.strToNum(aA,n.SCREEN_WIDTH);n.SCREEN_HEIGHT=a.strToNum(aB,n.SCREEN_HEIGHT);n.SCREEN_FACTOR=a.strToNum(aq,n.SCREEN_FACTOR);n.ZOOM_FACTOR=a.strToNum(aI,n.ZOOM_FACTOR);n.PLATFORM=a.strFullCheck(aH,n.PLATFORM);n.ID=a.strFullCheck(ay,n.ID);n.ANIMATE=a.strToNum(aD,n.ANIMATE);n.TRANSFORM=a.strToNum(ak,n.TRANSFORM);n.INPUT=a.strToNum(ag,n.INPUT);n.REMOTE=a.strToNum(am,n.REMOTE);
n.LAYOUT=a.strFullCheck(aE,n.LAYOUT);n.SCALE=a.strFullCheck(ar,n.SCALE);n.ZOOM=a.strFullCheck(ap,n.ZOOM);n.CENTER=a.strToNum(au,n.CENTER);n.BACKGROUND=a.strToNum(aC,n.BACKGROUND);n.LEAVE=a.strToNum(aF,n.LEAVE);n.EXIT=a.strToNum(ai,n.EXIT);n.BACK=a.strToNum(az,n.BACK);n.VOLUME=a.strToNum(ah,n.VOLUME);n.BUSY=a.strToNum(av,n.BUSY);n.SPEED=a.strToNum(at,n.SPEED);n.PLAYBACK=a.strToNum(aw,n.PLAYBACK);n.FULLSCREEN=a.strToNum(an,n.FULLSCREEN);n.SUSPEND=a.strToNum(al,n.SUSPEND);n.SECURE=a.strToNum(aG,n.SECURE);ab(ao)};this.onValidatedSettings=function(ag){if(typeof ag=="function"){if(ac){ag(Y)}else{U(ag)}}};this.handleSettingsEvent=function(ah){if(ah!=null&&a.isFullStr(ah.event)&&ah.event.indexOf("settings:")==0){var ag=ah.event.substr(9);if(ag=="animate"){n.ANIMATE=a.strToNum(ah.value,n.ANIMATE)}else{if(ag=="transform"){n.TRANSFORM=a.strToNum(ah.value,n.TRANSFORM)}else{if(ag=="input"){n.INPUT=a.strToNum(ah.value,n.INPUT)}else{if(ag=="remote"){n.REMOTE=a.strToNum(ah.value,n.REMOTE)}else{if(ag=="layout"){n.LAYOUT=a.strToNum(ah.value,n.LAYOUT)
}else{if(ag=="scale"){n.SCALE=a.strFullCheck(ah.value,n.SCALE)}else{if(ag=="zoom"){n.ZOOM=a.strFullCheck(ah.value,n.ZOOM)}}}}}}}}};this.getFrameworkInfo=function(ag){return a.strFullCheck(W(ag),"-")+" "+a.strFullCheck(X(ag),"-")};this.getApplicationInfo=function(ag){return a.strFullCheck(T(ag),"-")+" "+a.strFullCheck(aa(ag),"-")};this.getContentInfo=function(ag){return a.strFullCheck(S(ag),"-")+" "+a.strFullCheck(ae(ag),"-")};this.checkFramework=function(ai,ah,ag){return a.checkVersion(X(ai),ah)&&Z(W(ai),ag)};this.checkApplication=function(ai,ah,ag){return a.checkVersion(aa(ai),ah)&&Z(T(ai),ag)};this.checkContent=function(ai,ah,ag){return a.checkVersion(ae(ai),ah)&&Z(S(ai),ag)};this.isSameContentState=function(ah,ag){return ah!=null&&ag!=null&&ah.start===ag.start&&ah.restored===ag.restored&&ah.menuId===ag.menuId&&ah.menuFlag===ag.menuFlag&&ah.menuFocus===ag.menuFocus&&ah.menuIndex===ag.menuIndex&&ah.menuSize===ag.menuSize&&ah.contentId===ag.contentId&&ah.contentFlag===ag.contentFlag&&ah.contentFocus===ag.contentFocus&&ah.contentIndex===ag.contentIndex&&ah.contentSize===ag.contentSize&&ah.contentVisible===ag.contentVisible&&ah.panelId===ag.panelId&&ah.panelFlag===ag.panelFlag&&ah.panelFocus===ag.panelFocus&&ah.panelIndex===ag.panelIndex&&ah.panelSize===ag.panelSize&&ah.panelVisible===ag.panelVisible&&ah.videoVisible===ag.videoVisible&&ah.videoActive===ag.videoActive&&ah.playerVisible===ag.playerVisible&&ah.slideshowVisible===ag.slideshowVisible&&ah.volumeVisible===ag.volumeVisible&&ah.logVisible===ag.logVisible
